...
def insertarr(id_reservas, id_habitacion_reserva, id_usuario_reserva, tipo_reserva, fecha_reserva, fechaingre_reserva, fechasali_reserva, alojamiento_reserva, id_tipo_reserva):
    micursor=con.cursor()
